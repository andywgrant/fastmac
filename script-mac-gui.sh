...
# You’ll need to create a free https://ngrok.com/ account to get an auth token (needed for tcp tunnel and to remotely get the endpoint of the tunnel created) and replace “<ngrok_auth_token>” with this value.
mkdir /tmp/gui
